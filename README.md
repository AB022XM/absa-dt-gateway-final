...
To build the final jar and optimize the AbsaDtGatewayFinal application for production, run:
...
Then navigate to [http://localhost:9200](http://localhost:9200) in your browser.
