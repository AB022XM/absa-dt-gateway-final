...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ug.co.absa.africa.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ug.co.absa.africa.security.DomainUserDetailsService", "createSpringSecurityUser");
